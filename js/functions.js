class CellLife {
    ...
    print() {
        let colorsArray = ["#7cb342", "#689f38", "#558b2f", "#33691e"]
        this.ctx.clearRect(0, 0, this.size, this.size);
        for (let x = 0; x < this.size; x++) {
            for (let y = 0; y < this.size; y++) {
                if (this.cells[x][y])
                    this.ctx.fillStyle = colorsArray[this.randomIntFromInterval(0, 3)];
                else
...
const celullarAutomata = new CellLife(100, ctx, cells);
